...
--select *, datediff(day, planned_exam_date, getdate()) as number_of_days
--from students_modules
...
--from student_grades
--where exam_date between '2018-03-01' and '2018-03-31'  
...
--select * 
--from groups
--where left(group_no, 2) like '%M';

--select * 
--from groups
--where group_no like '______0_'
